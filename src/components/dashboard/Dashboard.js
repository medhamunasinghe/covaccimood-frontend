		...
		return (
			<div>
					...
					<Card>
						<Card.Body>
							...
							<div class="jumbotron jumbotron-fluid box">
								<div class="container">
									<h3 class=" font-weight-bold text-dark">Welcome To CoVacciMOOD Dashboard...</h3>
								</div>
							</div>
						</Card.Body>
					</Card>
				...
				<CardGroup>
					<Card>
						<Card.Body>
							<Card.Title>COVID-19 Vaccination Related Text Count {this.state.series[0].data[0] + this.state.series[0].data[1] + this.state.series[0].data[2]}</Card.Title>
							<div className="app">
								<div className="row">
					...
					<Card>
						<Card.Body>
							<Card.Title>COVID-19 Vaccination Sentiment Prediction Summary</Card.Title>
							<div class="box">
								<div className="donut">
									<Chart options={this.state.chart_2_options} series={this.state.chart_2_series} type="donut" width="380" />
								</div>
							</div>
						</Card.Body>
					</Card>
